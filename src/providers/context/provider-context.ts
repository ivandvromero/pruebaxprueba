...
export class ProviderContext {
  ...
  async getClientOrigin(externalId: string, userId: string) {
    try {
      ...
      clientOrigin.Field_K7_0009 = Number(client.CreationDate);
      clientOrigin.Field_K7_0011 = Number(
      ...
      clientOrigin.Field_K7_0020 = Number(client.CreationDate);
  ...
  async getProductOrigin(
    ...
    try {
      ...
      productOrigin.Field_K7_0065 = Number(product.creationDate);
  ...
  async getTransaction(eventObject) {
    ...
    transactionTransform.Field_K7_0087 = Number(transformDate(creationDate));
    transactionTransform.Field_K7_0088 = Number(
      transformDate(creationDateOneDay),
    );
    transactionTransform.Field_K7_0089 = Number(transformTime(creationDate));
    transactionTransform.Field_K7_0090 = bodyRSresponses.PTSId.replace(
      /PI/g,
      '',
    );
