...
describe('Transifya Recibir EventLog Strategy', () => {
  ...
  describe('TransifyaEnviarEventLogStrategy', () => {
    it('Transifya getCellPhoneOrigin', async () => {
      ...
      const result = transifyaRecibirStrategy.getCellPhoneOrigin(event);
    ...
    it('Transifya getgetOperators', async () => {
      const result = transifyaRecibirStrategy.getOperators(mockEventObject);
      expect(result).toBeDefined();
    });
    it('should return the same eventObject', () => {
      const result = transifyaRecibirStrategy.doAlgorithm(mockEventObject);
