...
export class IntrasolutionStrategy implements ProviderStrategy {
  ...
  public async doAlgorithm(
    ...
    try {
      ...
      data.transactionTransform.Field_K7_0091 = 'Intrasolución';
      ...
      data.transactionTransform.Field_K7_0104 = eventObject.CFO.general
        .transactionDetails
        ? eventObject.CFO.general.transactionDetails.substring(0, 20)
        : '';
  ...
  public async getProductDestination(
    ...
    try {
      ...
      productDestination.Field_K7_0077 = product.creationDate;
  ...
  async getClientDestination(externalId: string, eventObject: MessageEvent) {
    try {
      ...
      clientDestination.Field_K7_0038 = client.CreationDate;
      clientDestination.Field_K7_0040 = client.PersonDEO_dl_fecha_expedicion_c;
      ...
      clientDestination.Field_K7_0048 = client.CreationDate;
      clientDestination.Field_K7_0049 = client.CreationDate;
