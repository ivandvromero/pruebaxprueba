...
import { RecargaCBCachStrategy } from '../strategies/recarga-cb.strategy';
import { RetiroOtpCbStrategy } from '../strategies/retiro_otp_cb.strategy';
import { RetiroCBReverseStrategy } from '../strategies/reverso_retiro_cb.strategy';
...
export const transactionTypeStrategies = {
  ...
  TMA_CASHIN_PTS_DEPOSIT_CASH_IN: TmaRecibirReversoStrategy,
  ...
  RecargaCB_PTS_DEPOSIT_CASH_IN: RecargaCBCachStrategy,
  RETIRO_CB_PTS_WITHDRAW_CASH_OUT: RetiroOtpCbStrategy,
  'RETIRO_CB_PTS_REVERSE_CASH-OUT': RetiroCBReverseStrategy,
};

export const transactionTypes = {
  TMA_RECEIVE: 'TMA_CASHIN_PTS_DEPOSIT_CASH_IN',
  TMA_REVERSE: 'TMA_CASHIN_PTS_REVERSE_CASH_IN',
};
