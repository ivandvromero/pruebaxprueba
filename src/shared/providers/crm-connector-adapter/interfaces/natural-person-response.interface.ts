import { pepsEnum } from '@dale/client/common/enums';
...
export interface NaturalPersonResponseCRM {
  PartyId: number;
  PartyNumber: string;
  SourceSystem?: string;
  ...
  PersonDEO_dl_tipo_identificacion_c: identificationTypeEnum;
  PersonDEO_dl_numero_identificacion_c: string;
  PersonDEO_dl_genero_c?: string;
  PersonDEO_dl_peps_c?: pepsEnum;
...
export interface NaturalResponseByParamsCRM {
  items: NaturalPersonResponseCRM[];
  count: number;
  hasMore: boolean;
  limit: number;
  offset: number;
